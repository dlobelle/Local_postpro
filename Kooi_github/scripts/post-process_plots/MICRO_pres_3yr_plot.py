...
''' For MICRO presentation: plotting NPSG Ts and trajectories of 10x10 grid run for 3 years
Input here comes from: plot_Ts_Zs.py and plot_NPac3yrs_Ts_2004_allsizes.py
ONLY for rho = 920 kgm-3 and size = 1mm (but could go back to other scripts and run for other rho and size) '''
...
sizes = [3] # only this works now- for 1mm 
size_name = '1 mm'
si = sizes[0]
c = 0
r = 0 
...
#%%
'''Entire Pacific with box showing release location of 25 particles'''
...
'''Zoomed in box with initial locations '''
...
'''All trajectories throughout full 1000 days'''
...
'''Showing the 2 particles that sink'''
